...
Тему возьми ЛЁГКУЮ и бытовую — из повседневного: еда, привычки, быт, гаджеты, поп-культура, вкусы
(в духе: «пельмени — суп или второе», «тёмная тема против светлой», «кофе после обеда»).
Без политики, религии, насилия, трагедий и любых чувствительных тем — только безобидное и смешное.
